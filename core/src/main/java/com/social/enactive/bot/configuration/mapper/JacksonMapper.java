...
public class JacksonMapper {
     ...
     */
    private static final JacksonMapper SHARED_MAPPER;
     ...
     */
    public static JacksonMapper standardMapper() {
     ...
     */
    public static JacksonMapper customMapper(Consumer<ObjectMapper> customizer) {
